...
const projectsList: Project[] = [
  {
    ...
    image: './src/assets/portfolio/portfolio-project.png',
    link: '#',
  ...
  },
  {
    ...
    image: './src/assets/portfolio/zbir_project.png',
  ...
  },
  {
    ...
    image: './src/assets/portfolio/eventfirst_project.png',
  ...
  },
  {
    ...
    image: './src/assets/portfolio/cards_project.png',
...
The front-end is built with React and HTML/CSS, hosted on Netlify. The web application allows users to log in, filter articles by topic, and sort them by comment count, date, or likes in ascending or descending order, adding and deleting own comments`,
    ...
    image: './src/assets/portfolio/nc-news-project.png',
  ...
  },
  {
    ...
    image: './src/assets/portfolio/todo_project.png',
